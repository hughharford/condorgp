...
class GpStrategyZeroOneConfig(StrategyConfig, frozen=True):
    """
    ...
    # all these taken out for evolutionary simplicity
...
class GpStrategyZeroOne(Strategy):
    """
    ...
    def __init__(self, config: GpStrategyZeroOneConfig) -> None:
